...
<div class="login-box">
  ...
  <img src="./dist/img/logo_admin/lg.ico" class="img-circle elevation-3" alt="User Image">
    <a href="#"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="" method="post">
        ...
        <div class="row">
          <div class="col-12">
            <button type="submit" name="submit" class="btn btn-danger btn-block btn-flat">Login</button>
          </div>
        </div>    
      </form>
    </div>
