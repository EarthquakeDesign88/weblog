          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="tag[]" multiple="multiple" data-placeholder="Select a Tags" style="width: 100%;">
                ...
                <option value="germanyFood">Germany Food </option>
                <option value="japaneseFood">Japanese Food</option>
                <option value="englandFood">England Food</option>
                ...
                <option value="heautyFood">Heauty Food</option>
                <option value="dessertfood">Dessert Food</option>
                <option value="franceFood">France Food</option>
            ...
            <input type="checkbox" name="status" checked data-toggle="toggle" data-on="Active" data-off="Block" data-onstyle="success" data-offstyle="danger" data-style="ios">
          </div>
