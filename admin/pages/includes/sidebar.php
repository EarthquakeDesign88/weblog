    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#">
         Last login: <?php echo date_format(new DateTime( $_SESSION['last_login']), "j F Y H:i:s")?> <i class="fa fa-th-large"></i>
        </a>
      </li>
    </ul>
</nav>
...
<aside class="main-sidebar sidebar-dark-danger elevation-4 ">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../../dist/img/logo_admin/lg.ico" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
